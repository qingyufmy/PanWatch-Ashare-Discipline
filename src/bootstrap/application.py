...
from src.modules.portfolio.api import accounts, dashboard, discipline as portfolio_discipline, history
from src.modules.portfolio.api import journal as portfolio_journal
from src.modules.portfolio.api import model_roles as portfolio_model_roles
from src.modules.portfolio.api import issues as portfolio_issues
from src.modules.portfolio.api import workflow as portfolio_workflow
...
app.include_router(
    portfolio_discipline.router,
    prefix="/api/portfolio-discipline",
    tags=["portfolio-discipline"],
    dependencies=protected,
)
app.include_router(
    portfolio_journal.router,
    prefix="/api/portfolio-discipline",
    tags=["portfolio-discipline-journal"],
    dependencies=protected,
)
app.include_router(
    portfolio_model_roles.router,
    prefix="/api/model-roles",
    tags=["model-roles"],
    dependencies=protected,
)
app.include_router(
    portfolio_issues.router,
    prefix="/api/system-issues",
    tags=["system-issues"],
    dependencies=protected,
)
app.include_router(
    portfolio_workflow.router,
    prefix="/api/portfolio-workflow",
    tags=["portfolio-workflow"],
    dependencies=protected,
)
app.include_router(
    providers.router,

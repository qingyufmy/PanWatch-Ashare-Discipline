...
export default function DashboardPage() {
  ...
  const positionRatioPct = useMemo(() => {
    ...
    const { total_market_value, total_assets, declared_nav } = portfolioSummary.total
    const basis = declared_nav || total_assets
    return basis > 0 ? (total_market_value / basis) * 100 : null
  }, [portfolioSummary])

...
def _journal_action(raw_action: str, meta: dict | None = None) -> str:
    """Preserve five distinct portfolio actions in the audit journal."""
...
def save_suggestion(
    ...
    try:
        ...
        # Suggestion and frozen evidence commit atomically. A journal failure
        # rolls back the suggestion rather than publishing an untraceable action.
        ...
        journal_signal, _ = record_signal(
            ...
            ttl_seconds=max(1, int(expires_hours * 3600)),
            commit=False,
        )
